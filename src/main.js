...
const render = () => {
    ...
    if (profileMount) {
        if (currentView === 'profile') {
            ...
            profileMount.innerHTML = ProfileHeader();
        } else {
...
// Obsoletas, pero se mantienen por compatibilidad si algun onclick las llama (aunque store ya lo maneja)
// window.openDetail = (id) => { ... } // Se eliminara el bloque original mas abajo
window.openSettings = () => {
