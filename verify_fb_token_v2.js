...
const PAGE_ID = "963667040166127"; // ID del usuario, no pagina? El usuario dijo "PAGE ID: 9636..."
...
async function verify() {
    ...
    try {
        ...
        if (data.id === PAGE_ID) {
            ...
            console.log("❌ NO COINCIDE CON EL PAGE_ID PROPORCIONADO.");
            console.log(`Token ID: ${data.id}`);
            console.log(`Expected: ${PAGE_ID}`);
        }
